...
public class Map {
	...
	private String center = "24.367114,-26.015625";
	...
	public Map setCenter(String center) {
		this.center = center;
		return this;
	}
	...
	public String toString() {
		return "Map [layers=" + layers.toString() + ", width=" + width + ", height="
				+ height + ", center=" + center + ", attribution="
				+ attribution + ", zoom=" + zoom + ", minZoom=" + minZoom
				+ ", maxZoom=" + maxZoom + ", zoomControl=" + zoomControl
				+ ", zoomEnabled=" + zoomEnabled + ", dragging=" + dragging
